...
if (isset($submit)) {
	...
	if ($id_projeto_incluido != -1 )
	{
		...
		$insert_sql = "INSERT INTO participa (id_usuario, id_projeto, gerente) VALUES ($id_usuario_corrente, $id_projeto_incluido, $gerente  )";
...
<title>Erro</title>
<body>
	<p style="color: red; font-weight: bold; text-align: center">Nome de
...
<body>
	...
	<br>
	<i><a href="showSource.php?file=add_projeto.php">Veja o código fonte!</a>
	</i>
</body>
</html>
