...
if (isset($_POST['submit'])) {
    ...
    /** @Episodio 11: Se o login e senha estiverem corretos ent�oo registrar sess�o para o usu�rio, fechar login.php e abrir aplica��o . * */ else {
        ...
        $_SESSION['current_id_user'] = $current_id_user;
        ?>  
        <script language="javascript1.3">
