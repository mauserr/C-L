...
if (isset($id) && isset($t)) {      // SCRIPT CHAMADO PELO PROPRIO MAIN.PHP (OU PELA ARVORE) 
    ...
    if ($t == "c") {        // se for cenario 
        ...
        <?php echo nl2br(monta_links($result['context'], $vetorDeLexicos, $vetorDeCenarios)); ?>		 
                        </td> 
                    </tr> 
                    <tr> 
        ...
        <?php echo nl2br(monta_links($result['episodes'], $vetorDeLexicos, $vetorDeCenarios)); ?>
...
//            -Gerar xml deste projeto (ver Gerar relat�rios XML); 
                    ...
                    <TR> 
                        <td CLASS="Estilo"><a href="#" onClick="pedidoLexico();">Verificar pedidos de altera�aode termos do L�xico</a></td> 
                    </TR>
                    <TR> 
